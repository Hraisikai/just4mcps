...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:pointer-events-none dark:text-gray-400 dark:hover:text-gray-100">
        <X className="h-4 w-4" />
...
export const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 border-b border-gray-200 p-6",
